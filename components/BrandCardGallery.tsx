...
const BRANDS = [
    ...
    { id: 6, title: "ArcheForge Studio", subtitle: "Signal over noise, presence over posture", logo: "/brands/archeforge-studio.png", isFeatured: false },
...
export const BrandCardGallery: React.FC = () => {
    ...
    return (
        <section className="w-full bg-black py-20 md:py-32 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            >
                <a
                    href="https://www.soulprintengine.ai/"
                    target="_blank"
                ...
                >
                    ...
                    >
                        ...
                        {/* Card */}
                        <div className="relative bg-black rounded-2xl border border-orange-500/30 p-8 pb-14 text-center">
                            <img
                            ...
                            {/* Click indicator */}
                            <div className="absolute bottom-4 left-0 right-0 w-full text-center text-orange-500 text-xs font-inter tracking-wider uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300">
