...
const LandingHero: React.FC<LandingHeroProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Fallback background gradient (visible while video loads or on error) */}
      <div className={`absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black z-0 transition-opacity duration-1000 ${videoLoaded && !videoError ? 'opacity-0' : 'opacity-100'}`}></div>
